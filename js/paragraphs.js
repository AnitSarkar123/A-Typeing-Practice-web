...
const keySets = {
  a: ['aaaaa aaaaa aaaaa aaaaa', 'aa aa aaa aaaa aaaaa', 'a aa aaa aaaa aaaaa'],

  b: ['bbbbb bbbbb bbbbb', 'bb bb bbb bbbb'],

  c: ['ccccc ccccc ccccc', 'cc cc ccc cccc'],

  d: ['ddddd ddddd ddddd', 'dd dd ddd dddd'],

  e: ['eeeee eeeee eeeee', 'ee ee eee eeee'],

  f: ['fffff fffff fffff', 'ff ff fff ffff'],

  g: ['ggggg ggggg ggggg', 'gg gg ggg gggg'],

  h: ['hhhhh hhhhh hhhhh', 'hh hh hhh hhhh'],

  i: ['iiiii iiiii iiiii', 'ii ii iii iiii'],

  j: ['jjjjj jjjjj jjjjj', 'jj jj jjj jjjj'],

  k: ['kkkkk kkkkk kkkkk', 'kk kk kkk kkkk'],

  l: ['lllll lllll lllll', 'll ll lll llll'],

  m: ['mmmmm mmmmm mmmmm', 'mm mm mmm mmmm'],

  n: ['nnnnn nnnnn nnnnn', 'nn nn nnn nnnn'],

  o: ['ooooo ooooo ooooo', 'oo oo ooo oooo'],

  p: ['ppppp ppppp ppppp', 'pp pp ppp pppp'],

  q: ['qqqqq qqqqq qqqqq', 'qq qq qqq qqqq'],

  r: ['rrrrr rrrrr rrrrr', 'rr rr rrr rrrr'],

  s: ['sssss sssss sssss', 'ss ss sss ssss'],

  t: ['ttttt ttttt ttttt', 'tt tt ttt tttt'],

  u: ['uuuuu uuuuu uuuuu', 'uu uu uuu uuuu'],

  v: ['vvvvv vvvvv vvvvv', 'vv vv vvv vvvv'],

  w: ['wwwww wwwww wwwww', 'ww ww www wwww'],

  x: ['xxxxx xxxxx xxxxx', 'xx xx xxx xxxx'],

  y: ['yyyyy yyyyy yyyyy', 'yy yy yyy yyyy'],

  z: ['zzzzz zzzzz zzzzz', 'zz zz zzz zzzz'],

  numbers: ['11111 22222 33333 44444', '55555 66666 77777 88888', '99999 00000'],
